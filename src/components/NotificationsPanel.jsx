    ...
    <div style={{ position:'relative', width:'100%' }}>
      ...
      >
        ...
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', flex:1, opacity:sidebarOpen?1:0, transition:'opacity 150ms ease' }}>
          <span style={{ fontSize:13, fontWeight:500, color:open?'#5BA3C7':'rgba(255,255,255,0.65)', whiteSpace:'nowrap' }}>Notifications</span>
          {unread > 0 && (
            <span style={{ fontSize:10, fontWeight:700, color:'#fff', background:'#C75B4E', borderRadius:10, padding:'1px 6px' }}>{unread}</span>
          )}
        </div>
      </button>
