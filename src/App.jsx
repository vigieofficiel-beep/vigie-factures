  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0E0D0B", color: "#EDE8DB", fontFamily: "'Nunito Sans', sans-serif", overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", padding: "60px 24px 40px", textAlign: "center", maxWidth: 800, margin: "0 auto" }}>
        ...
        <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "rgba(212,168,83,0.08)", border: "1px solid rgba(212,168,83,0.2)", borderRadius: 20, padding: "6px 16px", fontSize: 11, color: "#D4A853", fontWeight: 600, marginBottom: 28 }}>
      ...
      {/* Pricing */}
      <div style={{ textAlign: "center", padding: "48px 24px 60px", maxWidth: 500, margin: "0 auto" }}>
        <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 28, marginBottom: 8, color: "#EDE8DB" }}>Simple et transparent</h2>
        <p style={{ color: "rgba(255,255,255,0.35)", fontSize: 13, marginBottom: 28 }}>Pas d'abonnement. Payez uniquement ce que vous utilisez.</p>
        <div style={{ background: "rgba(212,168,83,0.05)", border: "1px solid rgba(212,168,83,0.15)", borderRadius: 16, padding: "28px 24px" }}>
          <div style={{ fontSize: 42, fontWeight: 700, color: "#D4A853", fontFamily: "'Cormorant Garamond', serif" }}>~0.03€</div>
          <div style={{ color: "rgba(255,255,255,0.4)", fontSize: 13, marginBottom: 16 }}>par facture analysée</div>
          <div style={{ fontSize: 12, color: "rgba(255,255,255,0.3)", lineHeight: 1.8 }}>
            ✓ 5 agents IA spécialisés<br />✓ Détection d'anomalies<br />✓ Comparateur de prix<br />✓ Alertes email<br />✓ Dashboard illimité<br />✓ Export CSV
          </div>
        </div>
      </div>

      {/* Footer */}
      <div style={{ textAlign: "center", padding: "20px 24px 32px", borderTop: "1px solid rgba(255,255,255,0.04)" }}>
        <p style={{ color: "rgba(255,255,255,0.15)", fontSize: 11 }}>Vigie-Factures © 2026 — Propulsé par Claude AI</p>
      </div>
    </div>
  );
}
