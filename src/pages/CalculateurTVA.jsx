...
export default function CalculateurTVA() {
  const [mode,    setMode]    = useState('ht_vers_ttc'); // ht_vers_ttc | ttc_vers_ht
  ...
  return (
    <div style={{ fontFamily:"'Nunito Sans', sans-serif", padding:'32px 28px', maxWidth:900, margin:'0 auto' }}>
      ...
      <div style={{ marginBottom:28 }}>
        <h1 style={{ fontFamily:"'Cormorant Garamond', serif", fontSize:26, fontWeight:600, color:C.dark, margin:0 }}>Calculateur TVA</h1>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:20 }}>
        ...
        <div style={{ display:'flex', flexDirection:'column', gap:16 }}>
          ...
          {/* Taux TVA */}
          <Card>
            <label style={lS}>Taux de TVA</label>
            {TAUX_TVA.map(t=>(
        ...
        <div style={{ display:'flex', flexDirection:'column', gap:16 }}>
          ...
          <Card style={{ background:`linear-gradient(135deg, ${C.blue}08, ${C.purple}08)`, border:`1px solid ${C.blue}30` }}>
            ...
            <ResultLine label="Montant HT"  value={fmt(ht)}  />
            <ResultLine label={`TVA (${taux}%)`} value={fmt(tva)} color={C.orange} />
          ...
          {taux > 0 && m > 0 && (
            <Card>
              <h2 style={{ fontSize:12, fontWeight:700, color:C.light, textTransform:'uppercase', letterSpacing:'0.06em', margin:'0 0 14px' }}>TVA à déclarer</h2>
