...
<div class="conditions">
  <strong>Conditions de paiement :</strong> ${form.conditionsPaiement}
</div>
...
<div class="signature">
  <div class="sig-box">
    <div class="sig-label">Bon pour accord — Date et signature du client</div>
    <div class="sig-space"></div>
  </div>
  <div class="sig-box">
    <div class="sig-label">Signature de l'émetteur</div>
    <div class="sig-space"></div>
  </div>
</div>
    ...
    <div>
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 360px', gap: 20, alignItems: 'start' }}>
        <div>
          ...
          <CardSection title="Informations du devis" icon={Hash}>
            <FieldRow>
              <Field label="Numéro de devis" required><input style={inp} value={form.numeroDevis} onChange={e => set('numeroDevis', e.target.value)} /></Field>
              <Field label="Objet"><input style={inp} value={form.objet} onChange={e => set('objet', e.target.value)} placeholder="Développement site web..." /></Field>
            </FieldRow>
            <FieldRow>
              ...
              <Field label="Valable jusqu'au"><input style={inp} type="date" value={form.dateValidite} onChange={e => set('dateValidite', e.target.value)} /></Field>
            </FieldRow>
