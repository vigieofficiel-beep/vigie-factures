...
import {
  FileText, Calculator, Users, Shield, Scale,
          ...
          <div style={{
            ...
            <Link to="/" title="Retour au hub" style={{
              ...
              <div style={{
                ...
                background: 'linear-gradient(135deg, #2563EB, #5BA3C7)',
                display: 'flex', alignItems: 'center', justifyContent: 'center',
              }}>
                <span style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 16, fontWeight: 700, color: '#fff' }}>V</span>
              </div>
              <div style={{ overflow: 'hidden', opacity: isOpen ? 1 : 0, transition: 'opacity 150ms ease' }}>
                <div style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 18, fontWeight: 700, color: '#F8FAFC', whiteSpace: 'nowrap' }}>
          ...
          <div style={{ borderTop: '1px solid rgba(255,255,255,0.05)', padding: '12px 8px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '8px 8px', borderRadius: 10, marginBottom: 4 }}>
              <div style={{
                ...
                background: 'linear-gradient(135deg, rgba(37,99,235,0.3), rgba(91,163,199,0.2))',
                border: '1px solid rgba(91,163,199,0.3)',
                display: 'flex', alignItems: 'center', justifyContent: 'center',
              }}>
                <span style={{ fontSize: 13, fontWeight: 700, color: '#5BA3C7' }}>{userInitial}</span>
              </div>
              <div style={{ overflow: 'hidden', opacity: isOpen ? 1 : 0, transition: 'opacity 150ms ease' }}>
