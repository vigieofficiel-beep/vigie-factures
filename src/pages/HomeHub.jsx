  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        background: 'radial-gradient(ellipse, rgba(91,163,199,0.07) 0%, transparent 65%)',
      ...
      <nav style={{
        ...
        <div style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 22, fontWeight: 700, color: '#EDE8DB' }}>
          Vigie
        </div>
        <div style={{ display: 'flex', gap: 10 }}>
          <Link to="/login" style={{ padding: '8px 18px', borderRadius: 8, border: '1px solid rgba(255,255,255,0.1)', color: 'rgba(237,232,219,0.6)', fontSize: 13, fontWeight: 600, textDecoration: 'none', transition: 'all 0.2s' }}>
            Connexion
          </Link>
          <Link to="/pro/signup" style={{ padding: '8px 18px', borderRadius: 8, background: 'linear-gradient(135deg, #5BA3C7, #3d7fa8)', color: '#fff', fontSize: 13, fontWeight: 700, textDecoration: 'none' }}>
            S'inscrire
          </Link>
        </div>
      </nav>
      ...
      <section style={{
        ...
        <div style={{
          ...
          background: 'rgba(91,163,199,0.08)', border: '1px solid rgba(91,163,199,0.2)',
          ...
          <span style={{ fontSize: 11, fontWeight: 700, color: '#5BA3C7', letterSpacing: '0.1em', textTransform: 'uppercase' }}>
            Gestion d'entreprise · 100% français
          </span>
        </div>
        ...
        <h1 style={{
          ...
          fontWeight: 700, lineHeight: 0.95, letterSpacing: '-2px',
          color: '#EDE8DB', marginBottom: 28,
          animation: 'fadeUp 0.6s 0.1s ease both',
        }}>
          Vigie<br/>
          <em style={{ color: '#5BA3C7', fontStyle: 'italic' }}>Hub</em>
        </h1>

        {/* Sous-titre */}
        <p style={{
          fontSize: 'clamp(15px, 2vw, 19px)', color: 'rgba(237,232,219,0.5)',
          maxWidth: 520, lineHeight: 1.7, marginBottom: 52,
          animation: 'fadeUp 0.6s 0.2s ease both',
        }}>
          Votre espace de gestion tout-en-un. Pilotez votre activité,
          automatisez vos tâches et prenez les bonnes décisions.
        </p>

        {/* ── CARTES ESPACE ── */}
        <div style={{
          display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))',
          gap: 20, maxWidth: 620, width: '100%',
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            <Link to="/pro" style={{ textDecoration: 'none' }}
              ...
              <div style={{
                ...
                background: hoveredCard === 'pro'
                  ? 'linear-gradient(135deg, rgba(91,163,199,0.12), rgba(91,163,199,0.06))'
                  : 'rgba(255,255,255,0.04)',
                border: `1px solid ${hoveredCard === 'pro' ? 'rgba(91,163,199,0.4)' : 'rgba(255,255,255,0.08)'}`,
                borderRadius: 20, padding: '36px 28px',
                backdropFilter: 'blur(10px)',
                transform: hoveredCard === 'pro' ? 'translateY(-4px)' : 'translateY(0)',
                boxShadow: hoveredCard === 'pro' ? '0 20px 60px rgba(91,163,199,0.15)' : 'none',
                transition: 'all 0.3s ease',
              }}>
                {/* Lueur coin */}
                {hoveredCard === 'pro' && (
                  <div style={{ position: 'absolute', top: -30, right: -30, width: 120, height: 120, background: 'radial-gradient(circle, rgba(91,163,199,0.2), transparent 70%)', pointerEvents: 'none' }}/>
                )}
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 6, color: '#5BA3C7', fontSize: 13, fontWeight: 700 }}>
      ...
      <section style={{ position: 'relative', zIndex: 1, padding: '80px 6%', textAlign: 'center' }}>
        ...
        <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: 700, color: '#EDE8DB', marginBottom: 48, lineHeight: 1.2 }}>
          ...
          <em style={{ color: '#5BA3C7' }}>au même endroit</em>
        </h2>
      ...
      <section style={{
        position: 'relative', zIndex: 1,
        margin: '0 6% 80px', borderRadius: 24,
        background: 'linear-gradient(135deg, rgba(91,163,199,0.1) 0%, rgba(91,163,199,0.04) 100%)',
        border: '1px solid rgba(91,163,199,0.15)',
        ...
        <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
          <Link to="/pro/signup" style={{ padding: '13px 32px', borderRadius: 10, background: 'linear-gradient(135deg, #5BA3C7, #3d7fa8)', color: '#fff', fontSize: 14, fontWeight: 700, textDecoration: 'none', boxShadow: '0 4px 24px rgba(91,163,199,0.3)' }}>
            Créer mon compte Pro →
          </Link>
          <Link to="/pro/login" style={{ padding: '13px 28px', borderRadius: 10, border: '1px solid rgba(255,255,255,0.1)', color: 'rgba(237,232,219,0.6)', fontSize: 14, fontWeight: 600, textDecoration: 'none' }}>
            Se connecter
          </Link>
        </div>
      </section>
